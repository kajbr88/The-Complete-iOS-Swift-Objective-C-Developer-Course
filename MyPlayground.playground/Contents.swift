...
//var number1: Int = 25 //variables are placeholders for values in our program.
class KickBoxer {
    var name: String
    var punchPower:Int
    var punchSpeed: Int
    ...
    init(name: String, punchPower: Int, punchSpeed: Int, kickPower: Int,
         kickSpeed: Int ) {
        self.name = name
